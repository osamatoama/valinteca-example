...
schtasks /Create /TN PYTHON2 /TR "C:\Users\altoa\AppData\Local\Programs\Python\Python312\python.exe C:\xampp\htdocs\personal\valinteca\empty\public\python_live\glizer2.py" /SC MINUTE /MO 1
