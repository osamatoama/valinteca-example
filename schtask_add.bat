...
schtasks /Create /TN XAMPP /TR "C:\Users\altoa\AppData\Local\Programs\Python\Python312\python.exe C:/xampp/htdocs/personal/valinteca/empty/python/glizer.py" /SC MINUTE /MO 10
